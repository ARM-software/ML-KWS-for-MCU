 ...
 * Title:        arm_convolve_HWC_q7_basic_nonsquare.c
...
arm_status
arm_convolve_HWC_q7_basic_nonsquare(const q7_t * Im_in,
            ...
            if (pBuffer == bufferA + 2 * ch_im_in * dim_kernel_X * dim_kernel_Y)
            {
                pOut =
                    arm_nn_mat_mult_kernel_q7_q15(wt, bufferA,
                                                  ch_im_out,
                                                  ch_im_in *
                                                  dim_kernel_X * dim_kernel_Y, bias_shift, out_shift, bias, pOut);
